...
namespace Common.Utilities
{
    public static class CalendarExtensions
    {
        ...
        public static String CreatePersianTimeStamp()
        {
            ...
            return $"{nowDateTime.GetPersianYear()}{nowDateTime.GetPersianMonth().ToString().PadLeft(2, '0')}{nowDateTime.GetPersianDay().ToString().PadLeft(2, '0')}T{nowDateTime.Hour.ToString().PadLeft(2, '0')}{nowDateTime.Minute.ToString().PadLeft(2, '0')}{nowDateTime.Second.ToString().PadLeft(2, '0')}";
        }
        ...
        public static string MasfaTimeFormatToDateTime(string masfaDateTime)
        {
            ...
            var output = year + "/" + month + "/" + day + " - " + hour + ":" + minute + ":" + second;
