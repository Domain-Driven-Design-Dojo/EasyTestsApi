...
namespace DataTransferObjects.DataTransferObjects.UserDTOs
{
    ...
    public class UserCuDto : BaseDto<UserCuDto, ApplicationUser, long>, IValidatableObject
    {
        ...
        public override void CustomMappings(AutoMapper.IMappingExpression<UserCuDto, ApplicationUser> mappingExpression)
        {
            mappingExpression
                ...
                .ForMember(dest => dest.FullName, opt =>
                    opt.MapFrom(src =>
                        src.Person.IndividualPerson == null
                            ...
                            : String.Concat((string?)src.Person.IndividualPerson.FirstName, (string?)" ",
                                (string?)src.Person.IndividualPerson.LastName)));
        }
    }
